...
import { SHORTCUTS, ShortcutMatcher } from "@/shared/lib/keyboard/shortcuts";
 ...
 * 
 * @param {UseKeyboardShortcutsOptions} options - Shortcut configuration
 * @param {boolean} [options.enabled=true] - Whether shortcuts are enabled
 * @param {ShortcutHandlers} options.handlers - Handlers for each shortcut
 */
