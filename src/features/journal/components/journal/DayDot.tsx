...
// Memoize DayDot to prevent unnecessary re-renders when props haven't changed
export const DayDot = memo(DayDotComponent, (prevProps, nextProps) => {
  return (
